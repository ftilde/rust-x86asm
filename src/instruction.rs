...
impl Reg {
    pub fn get_reg_type(&self) -> RegType {
        if self.is_general() {
            ...
            RegType::Segment
        } else if self.is_bounds() {
            RegType::Bound
        } else {
            panic!("Unknown register type for {:?}.", self);
        }
    }
    ...
    pub fn is_8_bit(&self) -> bool {
        self.size() == OperandSize::Byte
    }
    pub fn is_16_bit(&self) -> bool {
        self.size() == OperandSize::Word
    }
    pub fn is_32_bit(&self) -> bool {
        self.size() == OperandSize::Dword
    }
    pub fn is_64_bit(&self) -> bool {
        self.size() == OperandSize::Qword
    }
    pub fn is_128_bit(&self) -> bool {
        self.size() == OperandSize::Xmmword
    }
    pub fn is_256_bit(&self) -> bool {
        self.size() == OperandSize::Ymmword
    }
    pub fn is_512_bit(&self) -> bool {
        self.size() == OperandSize::Zmmword
    }

    pub fn is_control(&self) -> bool {
        match *self {
            Reg::CR0 | Reg::CR1 | Reg::CR2 | Reg::CR3 | Reg::CR4 | Reg::CR8 => true,
            _ => false,
        }
    }
    ...
    pub fn is_segment(&self) -> bool {
        match *self {
            Reg::CS | Reg::DS | Reg::ES | Reg::FS | Reg::GS | Reg::SS => true,
            _ => false,
        }
    }
    ...
    pub fn is_test(&self) -> bool {
        match *self {
            Reg::TR3 | Reg::TR4 | Reg::TR5 | Reg::TR6 | Reg::TR7 => true,
            _ => false,
        }
    }
    ...
    pub fn is_mask(&self) -> bool {
        match *self {
            Reg::K0 | Reg::K1 | Reg::K2 | Reg::K3 | Reg::K4 | Reg::K5 | Reg::K6 | Reg::K7 => true,
            _ => false,
        }
    }
    ...
    pub fn get_reg_code(&self) -> u8 {
        match *self {
            ...
            Reg::R10B | Reg::R10W | Reg::R10D | Reg::R10 | Reg::XMM10 | Reg::YMM10 | Reg::ZMM10 => {
                10
            }
            Reg::R11B | Reg::R11W | Reg::R11D | Reg::R11 | Reg::XMM11 | Reg::YMM11 | Reg::ZMM11 => {
                11
            }
            Reg::R12B | Reg::R12W | Reg::R12D | Reg::R12 | Reg::XMM12 | Reg::YMM12 | Reg::ZMM12 => {
                12
            }
            Reg::R13B | Reg::R13W | Reg::R13D | Reg::R13 | Reg::XMM13 | Reg::YMM13 | Reg::ZMM13 => {
                13
            }
            Reg::R14B | Reg::R14W | Reg::R14D | Reg::R14 | Reg::XMM14 | Reg::YMM14 | Reg::ZMM14 => {
                14
            }
            Reg::R15B | Reg::R15W | Reg::R15D | Reg::R15 | Reg::XMM15 | Reg::YMM15 | Reg::ZMM15 => {
                15
            }
    ...
    pub fn needs_rex(&self) -> bool {
        match *self {
            Reg::SPL | Reg::BPL | Reg::SIL | Reg::DIL => true,
            _ => false,
        }
    }
