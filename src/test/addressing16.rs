...
fn encode_indirect() {
    ...
    encode16_helper2(
        Mnemonic::ADD,
        Operand::Direct(Reg::AX),
        Operand::Memory(0x05, Some(OperandSize::Word), None),
        &vec![0x03, 0x06, 0x05, 0x00],
    );
    encode16_helper2(
        Mnemonic::ADD,
        Operand::Direct(Reg::AX),
    ...
    encode16_helper2(
        Mnemonic::ADD,
        Operand::Direct(Reg::AX),
        Operand::Indirect(Reg::BP, Some(OperandSize::Word), None),
        &vec![0x03, 0x46, 0x00],
    );
}
