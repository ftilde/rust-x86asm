...
fn address_size_prefix() {
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::CX),
            Operand::Indirect(Reg::BX, Some(OperandSize::Word), None),
        ),
    );
    decode_helper(
        &vec![0x67, 0x8B, 0x0B],
        Mode::Real, // MOV CX, [EBX]
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::CX),
            Operand::Indirect(Reg::EBX, Some(OperandSize::Word), None),
        ),
    );
    ...
    decode_helper(
        &vec![0x67, 0x8B, 0x0F],
        Mode::Protected, // MOV ECX, [BX]
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::ECX),
            Operand::Indirect(Reg::BX, Some(OperandSize::Dword), None),
        ),
    );
    ...
    decode_helper(
        &vec![0x48, 0x8B, 0x0B],
        Mode::Long, // MOV RCX, QWORD PTR [RBX]
        &Instruction::new2(
            Mnemonic::MOV,
    ...
    decode_helper(
        &vec![0x67, 0x48, 0x8B, 0x0B],
        Mode::Long, // MOV RCX, QWORD PTR [EBX]
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::RCX),
            Operand::Indirect(Reg::EBX, Some(OperandSize::Qword), None),
        ),
    );
}
...
fn mod_rm_real_mod_0() {
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BX+SI]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BX+DI]
            Operand::IndirectScaledIndexed(
                Reg::BX,
                Reg::DI,
                RegScale::One,
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BP+SI]
            Operand::IndirectScaledIndexed(
                Reg::BP,
                Reg::SI,
                RegScale::One,
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BP+DI]
            Operand::IndirectScaledIndexed(
                Reg::BP,
                Reg::DI,
                RegScale::One,
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [SI]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [DI]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [0x1234]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BX]
            Operand::Indirect(Reg::BX, Some(OperandSize::Word), None),
        ),
    );
}
...
fn mod_rm_real_mod_1() {
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BX+SI+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BX+DI+0x12]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::BX,
                Reg::DI,
                RegScale::One,
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BP+SI+0x12]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::BP,
                Reg::SI,
                RegScale::One,
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BP+DI+0x12]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::BP,
                Reg::DI,
                RegScale::One,
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [SI+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [DI+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BP+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BX+0x12]
...
fn mod_rm_real_mod_2() {
    decode_helper(
        &vec![0x8b, 0x80, 0x34, 0x12],
        Mode::Real,
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BX+SI+0x1234]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::BX,
                Reg::SI,
                RegScale::One,
    ...
    decode_helper(
        &vec![0x8b, 0x81, 0x34, 0x12],
        Mode::Real,
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BX+DI+0x1234]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::BX,
                Reg::DI,
                RegScale::One,
    ...
    decode_helper(
        &vec![0x8b, 0x82, 0x34, 0x12],
        Mode::Real,
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BP+SI+0x1234]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::BP,
                Reg::SI,
                RegScale::One,
    ...
    decode_helper(
        &vec![0x8b, 0x83, 0x34, 0x12],
        Mode::Real,
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BP+DI+0x1234]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::BP,
                Reg::DI,
                RegScale::One,
    ...
    decode_helper(
        &vec![0x8b, 0x84, 0x34, 0x12],
        Mode::Real,
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [SI+0x1234]
            Operand::IndirectDisplaced(Reg::SI, 0x1234, Some(OperandSize::Word), None),
        ),
    );
    decode_helper(
        &vec![0x8b, 0x85, 0x34, 0x12],
        Mode::Real,
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [DI+0x1234]
            Operand::IndirectDisplaced(Reg::DI, 0x1234, Some(OperandSize::Word), None),
        ),
    );
    decode_helper(
        &vec![0x8b, 0x86, 0x34, 0x12],
        Mode::Real,
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BP+0x1234]
            Operand::IndirectDisplaced(Reg::BP, 0x1234, Some(OperandSize::Word), None),
        ),
    );
    decode_helper(
        &vec![0x8b, 0x87, 0x34, 0x12],
        Mode::Real,
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AX), // MOV AX, [BX+0x1234]
...
fn mod_rm_protected_mod_0() {
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EAX]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ECX]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EDX]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EBX]
            Operand::Indirect(Reg::EBX, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ESP]
            Operand::Indirect(Reg::ESP, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x05, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, DS:0x12345678
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ESI]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EDI]
...
fn mod_rm_protected_mod_1() {
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EAX+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ECX+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EDX+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EBX+0x12]
            Operand::IndirectDisplaced(Reg::EBX, 0x12, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x44, 0x24, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ESP+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EBP+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ESI+0x12]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EDI+0x12]
...
fn mod_rm_protected_mod_2() {
    decode_helper(
        &vec![0x03, 0x80, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EAX+0x12345678]
            Operand::IndirectDisplaced(Reg::EAX, 0x12345678, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x81, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ECX+0x12345678]
            Operand::IndirectDisplaced(Reg::ECX, 0x12345678, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x82, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EDX+0x12345678]
            Operand::IndirectDisplaced(Reg::EDX, 0x12345678, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x83, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EBX+0x12345678]
            Operand::IndirectDisplaced(Reg::EBX, 0x12345678, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x84, 0x24, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ESP+0x12345678]
            Operand::IndirectDisplaced(Reg::ESP, 0x12345678, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x85, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EBP+0x12345678]
            Operand::IndirectDisplaced(Reg::EBP, 0x12345678, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x86, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ESI+0x12345678]
            Operand::IndirectDisplaced(Reg::ESI, 0x12345678, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x87, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [EDI+0x12345678]
...
fn sib_protected_mod_0() {
    ...
    decode_helper(
        &vec![0x03, 0x04, 0x8D, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD EAX, [ECX*4+0x12345678]
...
fn sib_protected_mod_1() {
    decode_helper(
        &vec![0x03, 0x44, 0x58, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD [EAX+EBX*2+0x12]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::EAX,
                Reg::EBX,
                RegScale::Two,
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD [ECX+0x12]
            Operand::IndirectDisplaced(Reg::ECX, 0x12, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x44, 0xFE, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD [ESI+EDI*8+0x12]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::ESI,
                Reg::EDI,
                RegScale::Eight,
...
fn sib_protected_mod_2() {
    decode_helper(
        &vec![0x03, 0x84, 0x58, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD [EAX+EBX*2+0x12345678]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::EAX,
                Reg::EBX,
                RegScale::Two,
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD [ECX+0x12345678]
            Operand::IndirectDisplaced(Reg::ECX, 0x12345678, Some(OperandSize::Dword), None),
        ),
    );
    decode_helper(
        &vec![0x03, 0x84, 0xFE, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::EAX), // ADD [ESI+EDI*8+0x12345678]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::ESI,
                Reg::EDI,
                RegScale::Eight,
...
fn mod_rm_long_mod_0() {
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RAX]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RCX]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RDX]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RBX]
            Operand::Indirect(Reg::RBX, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x04, 0x24],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RSP]
            Operand::Indirect(Reg::RSP, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x05, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RIP+0x12345678]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RSI]
    ...
    decode_helper(
        ...
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RDI]
...
fn mod_rm_long_mod_1() {
    decode_helper(
        &vec![0x48, 0x03, 0x40, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RAX+0x12]
            Operand::IndirectDisplaced(Reg::RAX, 0x12, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x41, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RCX+0x12]
            Operand::IndirectDisplaced(Reg::RCX, 0x12, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x42, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RDX+0x12]
            Operand::IndirectDisplaced(Reg::RDX, 0x12, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x43, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RBX+0x12]
            Operand::IndirectDisplaced(Reg::RBX, 0x12, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x44, 0x24, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RSP+0x12]
            Operand::IndirectDisplaced(Reg::RSP, 0x12, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x45, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RBP+0x12]
            Operand::IndirectDisplaced(Reg::RBP, 0x12, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x46, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RSI+0x12]
            Operand::IndirectDisplaced(Reg::RSI, 0x12, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x47, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RDI+0x12]
...
fn mod_rm_long_mod_2() {
    decode_helper(
        &vec![0x48, 0x03, 0x80, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RAX+0x12345678]
            Operand::IndirectDisplaced(Reg::RAX, 0x12345678, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x81, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RCX+0x12345678]
            Operand::IndirectDisplaced(Reg::RCX, 0x12345678, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x82, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RDX+0x12345678]
            Operand::IndirectDisplaced(Reg::RDX, 0x12345678, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x83, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RBX+0x12345678]
            Operand::IndirectDisplaced(Reg::RBX, 0x12345678, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x84, 0x24, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RSP+0x12345678]
            Operand::IndirectDisplaced(Reg::RSP, 0x12345678, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x85, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RBP+0x12345678]
            Operand::IndirectDisplaced(Reg::RBP, 0x12345678, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x86, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RSI+0x12345678]
            Operand::IndirectDisplaced(Reg::RSI, 0x12345678, Some(OperandSize::Qword), None),
        ),
    );
    decode_helper(
        &vec![0x48, 0x03, 0x87, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RDI+0x12345678]
...
fn sib_long_mod_0() {
    decode_helper(
        &vec![0x48, 0x03, 0x04, 0x58],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RAX+RBX*2]
            Operand::IndirectScaledIndexed(
                Reg::RAX,
                Reg::RBX,
                RegScale::Two,
...
fn sib_long_mod_1() {
    decode_helper(
        &vec![0x48, 0x03, 0x44, 0x58, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RAX+RBX*2+0x12]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::RAX,
                Reg::RBX,
                RegScale::Two,
    ...
    decode_helper(
        &vec![0x48, 0x03, 0x44, 0xFE, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RSI+RDI*8+0x12]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::RSI,
                Reg::RDI,
                RegScale::Eight,
...
fn sib_long_mod_2() {
    decode_helper(
        &vec![0x48, 0x03, 0x84, 0x58, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RAX+RBX*2+0x12345678]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::RAX,
                Reg::RBX,
                RegScale::Two,
    ...
    decode_helper(
        &vec![0x48, 0x03, 0x84, 0xFE, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX), // ADD RAX, [RSI+RDI*8+0x12345678]
            Operand::IndirectScaledIndexedDisplaced(
                Reg::RSI,
                Reg::RDI,
                RegScale::Eight,
...
fn addressing_mode_a() {
    decode_helper(
        &vec![0xEA, 0xAB, 0x90, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new1(
            Mnemonic::JMP,
            Operand::MemoryAndSegment32(0x1234, 0x567890AB),
        ),
    ); // JMP 0x1234:567890AB
}
...
fn addressing_mode_j() {
    decode_helper(
        &vec![0xE9, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new1(Mnemonic::JMP, Operand::Offset(0x12345678, None, None)),
    ); // JMP 0x12345678
}
...
fn addressing_mode_n() {
    decode_helper(
        &vec![0x0F, 0x71, 0xD5, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::PSRLW,
            Operand::Direct(Reg::MM5),
            Operand::Literal8(0x12),
        ),
    ); // PSRLW MM5, 0x12
}
...
fn addressing_mode_o() {
    decode_helper(
        &vec![0xA0, 0x78, 0x56, 0x34, 0x12],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::MOV,
            Operand::Direct(Reg::AL),
            Operand::Offset(0x12345678, Some(OperandSize::Byte), None),
        ),
    ); // MOV AL, DS:0x12345678
}
...
fn addressing_mode_z() {
    decode_helper(
        &vec![0x41],
        Mode::Protected,
        &Instruction::new1(Mnemonic::INC, Operand::Direct(Reg::ECX)),
    ); // ECX
}
...
fn addressing_mode_avx_rm() {
    decode_helper(
        &vec![0xC5, 0xD9, 0x58, 0xDD],
        Mode::Long,
        &Instruction::new3(
            Mnemonic::VADDPD,
            Operand::Direct(Reg::XMM3),
            Operand::Direct(Reg::XMM4),
            Operand::Direct(Reg::XMM5),
        ),
...
fn addressing_mode_avx_mem_bcast32_rm() {
    decode_helper(
        &vec![0x62, 0xF1, 0x6C, 0x18, 0x5E, 0x08],
        Mode::Protected,
        &Instruction {
...
fn addressing_mode_avx_mem_bcast64_rm() {
    decode_helper(
        &vec![0x62, 0xF1, 0xED, 0x18, 0x5E, 0x08],
        Mode::Protected,
        &Instruction {
...
fn addressing_mode_avx_imm8() {
    decode_helper(
        &vec![0xC4, 0xE3, 0x69, 0x4B, 0xCB, 0x40],
        Mode::Long,
        &Instruction {
...
fn addressing_mode_avx_dest_mem_rm() {
    decode_helper(
        &vec![0x62, 0xF1, 0x7C, 0x2B, 0x29, 0x18],
        Mode::Protected,
        &Instruction {
            mnemonic: Mnemonic::VMOVAPS,
            operand1: Some(Operand::Indirect(
                Reg::EAX,
...
fn addressing_mode_mask_vex() {
    decode_helper(
        &vec![0xC5, 0xD5, 0x4A, 0xE6],
        Mode::Long,
        &Instruction::new3(
            Mnemonic::KADDB,
            Operand::Direct(Reg::K4),
            Operand::Direct(Reg::K5),
            Operand::Direct(Reg::K6),
        ),
    ); // KADDB K4, K5, K6
}
...
fn addressing_mode_mask_mem_rm() {
    decode_helper(
        &vec![0xC5, 0xF9, 0x90, 0x30],
        Mode::Protected,
        &Instruction::new2(
            Mnemonic::KMOVB,
            Operand::Direct(Reg::K6),
            Operand::Indirect(Reg::EAX, Some(OperandSize::Byte), None),
        ),
    ); // KMOVB K6, [EAX]
}
...
fn operand_type_vds() {
    ...
    decode_helper(
        &vec![0x48, 0x05, 0x78, 0x56, 0x34, 0x12],
        Mode::Long,
        &Instruction::new2(
            Mnemonic::ADD,
            Operand::Direct(Reg::RAX),
...
fn operand_type_xmm_or_ymm_or_mem_or_mem64() {
    ...
    decode_helper(
        &vec![0x62, 0xF1, 0xFD, 0x18, 0x5A, 0x08],
        Mode::Long,
        &Instruction {
    ...
    decode_helper(
        &vec![0x62, 0xF1, 0xFD, 0x38, 0x5A, 0x08],
        Mode::Long,
        &Instruction {
            mnemonic: Mnemonic::VCVTPD2PS,
            operand1: Some(Operand::Direct(Reg::XMM1)),
...
fn operand_type_ymm_or_mem_or_mem32() {
    ...
    decode_helper(
        &vec![0x62, 0xF1, 0x7C, 0x58, 0x5A, 0x08],
        Mode::Long,
        &Instruction {
...
fn operand_type_ymm_or_mem_or_mem64() {
    ...
    decode_helper(
        &vec![0x62, 0xF1, 0xFF, 0x38, 0xE6, 0x08],
        Mode::Long,
        &Instruction {
...
fn operand_type_zmm_or_mem_or_mem64() {
    ...
    decode_helper(
        &vec![0x62, 0xF1, 0xFD, 0x58, 0x5A, 0x08],
        Mode::Long,
        &Instruction {
            mnemonic: Mnemonic::VCVTPD2PS,
...
fn operand_type_avx() {
    ...
    decode_helper(
        &vec![0x62, 0xF1, 0xED, 0x4A, 0x58, 0xCB],
        Mode::Long,
        &Instruction {
            mnemonic: Mnemonic::VADDPD,
            operand1: Some(Operand::Direct(Reg::ZMM1)),
