...
fn vmovntdq_1() {
    run_test(
        ...
        &[197, 249, 231, 36, 77, 237, 152, 216, 50],
        OperandSize::Dword,
    )
}
...
fn vmovntdq_4() {
    run_test(
        &Instruction {
            mnemonic: Mnemonic::VMOVNTDQ,
            operand1: Some(Indirect(RCX, Some(OperandSize::Ymmword), None)),
...
fn vmovntdq_8() {
    run_test(
        ...
        &[197, 253, 231, 36, 133, 235, 68, 193, 3],
        OperandSize::Qword,
    )
}
...
fn vmovntdq_9() {
    run_test(
        ...
        &[98, 241, 125, 72, 231, 128, 131, 80, 126, 87],
        OperandSize::Dword,
    )
}
