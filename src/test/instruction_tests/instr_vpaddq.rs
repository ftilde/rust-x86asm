...
fn vpaddq_6() {
    run_test(
        ...
        &[197, 237, 212, 129, 232, 159, 145, 126],
        OperandSize::Dword,
    )
}
...
fn vpaddq_8() {
    run_test(
        ...
        &[197, 221, 212, 20, 93, 143, 182, 184, 58],
        OperandSize::Qword,
    )
}
...
fn vpaddq_10() {
    run_test(
        ...
        &[98, 241, 197, 137, 212, 28, 77, 125, 99, 151, 4],
        OperandSize::Dword,
    )
}
...
fn vpaddq_14() {
    run_test(
        ...
        &[98, 241, 221, 148, 212, 12, 117, 157, 22, 231, 26],
        OperandSize::Qword,
    )
}
