...
fn vfmsub132sd_2() {
    run_test(
        ...
        &[196, 226, 241, 155, 12, 85, 212, 160, 198, 42],
        OperandSize::Dword,
    )
}
...
fn vfmsub132sd_4() {
    run_test(
        ...
        &[196, 226, 201, 155, 170, 60, 181, 146, 31],
        OperandSize::Qword,
    )
}
...
fn vfmsub132sd_6() {
    run_test(
        ...
        &[98, 242, 197, 141, 155, 146, 214, 44, 114, 76],
        OperandSize::Dword,
    )
}
...
fn vfmsub132sd_8() {
    run_test(
        ...
        &[98, 226, 245, 133, 155, 188, 91, 200, 64, 104, 40],
        OperandSize::Qword,
    )
}
