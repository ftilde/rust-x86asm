...
fn vdpps_2() {
    run_test(
        ...
        &[196, 227, 81, 64, 162, 241, 249, 27, 67, 70],
        OperandSize::Dword,
    )
}
...
fn vdpps_4() {
    run_test(
        ...
        &[196, 227, 81, 64, 191, 133, 234, 230, 65, 88],
        OperandSize::Qword,
    )
}
...
fn vdpps_8() {
    run_test(
        ...
        &[196, 227, 101, 64, 188, 90, 232, 235, 11, 35, 14],
        OperandSize::Qword,
    )
}
