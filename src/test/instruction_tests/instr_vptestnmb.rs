...
fn vptestnmb_2() {
    run_test(
        ...
        &[98, 242, 126, 12, 38, 140, 86, 7, 105, 133, 85],
        OperandSize::Dword,
    )
}
...
fn vptestnmb_6() {
    run_test(
        ...
        &[98, 242, 126, 45, 38, 36, 181, 158, 198, 222, 63],
        OperandSize::Dword,
    )
}
...
fn vptestnmb_8() {
    run_test(
        ...
        &[98, 242, 78, 47, 38, 188, 72, 62, 215, 128, 67],
        OperandSize::Qword,
    )
}
...
fn vptestnmb_10() {
    run_test(
        ...
        &[98, 242, 118, 78, 38, 12, 77, 47, 167, 68, 20],
        OperandSize::Dword,
    )
}
...
fn vptestnmb_12() {
    run_test(
        ...
        &[98, 242, 62, 68, 38, 148, 201, 17, 247, 254, 41],
        OperandSize::Qword,
    )
}
