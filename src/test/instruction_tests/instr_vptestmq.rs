...
fn vptestmq_2() {
    run_test(
        ...
        &[98, 242, 245, 10, 39, 152, 190, 141, 158, 0],
        OperandSize::Dword,
    )
}
...
fn vptestmq_5() {
    run_test(
        ...
        &[98, 242, 221, 14, 39, 140, 247, 7, 211, 234, 120],
        OperandSize::Qword,
    )
}
...
fn vptestmq_6() {
    run_test(
        ...
        &[98, 242, 181, 28, 39, 36, 253, 16, 88, 254, 79],
        OperandSize::Qword,
    )
}
...
fn vptestmq_8() {
    run_test(
        ...
        &[98, 242, 245, 41, 39, 188, 128, 254, 109, 34, 17],
        OperandSize::Dword,
    )
}
...
fn vptestmq_11() {
    run_test(
        ...
        &[98, 242, 197, 46, 39, 36, 213, 251, 215, 230, 51],
        OperandSize::Qword,
    )
}
...
fn vptestmq_15() {
    run_test(
        ...
        &[98, 242, 221, 94, 39, 156, 147, 216, 17, 224, 55],
        OperandSize::Dword,
    )
}
