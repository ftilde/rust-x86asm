...
fn vpblendmq_3() {
    run_test(
        ...
        &[98, 242, 205, 154, 100, 164, 206, 50, 105, 45, 21],
        OperandSize::Dword,
    )
}
...
fn vpblendmq_5() {
    run_test(
        ...
        &[98, 114, 157, 130, 100, 28, 117, 192, 186, 127, 84],
        OperandSize::Qword,
    )
}
...
fn vpblendmq_8() {
    run_test(
        ...
        &[98, 242, 253, 173, 100, 176, 40, 187, 197, 90],
        OperandSize::Dword,
    )
}
...
fn vpblendmq_9() {
    run_test(
        ...
        &[98, 242, 197, 186, 100, 161, 198, 72, 209, 53],
        OperandSize::Dword,
    )
}
...
fn vpblendmq_14() {
    run_test(
        ...
        &[98, 242, 221, 204, 100, 132, 115, 199, 209, 193, 117],
        OperandSize::Dword,
    )
}
...
fn vpblendmq_15() {
    run_test(
        ...
        &[98, 242, 245, 222, 100, 4, 157, 238, 109, 23, 75],
        OperandSize::Dword,
    )
}
...
fn vpblendmq_17() {
    run_test(
        ...
        &[98, 98, 157, 199, 100, 158, 15, 90, 120, 111],
        OperandSize::Qword,
    )
}
...
fn vpblendmq_18() {
    run_test(
        ...
        &[98, 242, 221, 219, 100, 188, 215, 167, 120, 98, 95],
        OperandSize::Qword,
    )
}
