...
fn vpcompressd_2() {
    run_test(
        ...
        &[98, 242, 125, 8, 139, 36, 221, 255, 125, 159, 56],
        OperandSize::Dword,
    )
}
...
fn vpcompressd_8() {
    run_test(
        ...
        &[98, 226, 125, 40, 139, 172, 126, 49, 45, 78, 113],
        OperandSize::Qword,
    )
}
...
fn vpcompressd_10() {
    run_test(
        ...
        &[98, 242, 125, 72, 139, 12, 133, 20, 175, 185, 66],
        OperandSize::Dword,
    )
}
...
fn vpcompressd_12() {
    run_test(
        ...
        &[98, 226, 125, 72, 139, 44, 85, 122, 248, 251, 124],
        OperandSize::Qword,
    )
}
