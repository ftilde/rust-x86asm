...
fn vrcp28pd_2() {
    run_test(
        ...
        &[98, 242, 253, 201, 202, 20, 69, 226, 227, 72, 107],
        OperandSize::Dword,
    )
}
...
fn vrcp28pd_5() {
    run_test(
        ...
        &[98, 242, 253, 203, 202, 146, 71, 163, 239, 4],
        OperandSize::Qword,
    )
}
