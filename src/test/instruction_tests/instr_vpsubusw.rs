...
fn vpsubusw_8() {
    run_test(
        ...
        &[197, 197, 217, 60, 149, 10, 12, 109, 19],
        OperandSize::Qword,
    )
}
...
fn vpsubusw_10() {
    run_test(
        ...
        &[98, 241, 69, 143, 217, 139, 11, 194, 241, 37],
        OperandSize::Dword,
    )
}
...
fn vpsubusw_16() {
    run_test(
        ...
        &[98, 97, 85, 169, 217, 188, 202, 228, 125, 226, 40],
        OperandSize::Qword,
    )
}
