...
fn vpmovusdw_2() {
    run_test(
        ...
        &[98, 242, 126, 8, 19, 138, 80, 61, 135, 13],
        OperandSize::Dword,
    )
}
...
fn vpmovusdw_6() {
    run_test(
        ...
        &[98, 242, 126, 40, 19, 180, 250, 254, 48, 201, 31],
        OperandSize::Dword,
    )
}
...
fn vpmovusdw_8() {
    run_test(
        ...
        &[98, 242, 126, 40, 19, 4, 77, 98, 70, 40, 64],
        OperandSize::Qword,
    )
}
...
fn vpmovusdw_10() {
    run_test(
        ...
        &[98, 242, 126, 72, 19, 150, 248, 91, 58, 80],
        OperandSize::Dword,
    )
}
...
fn vpmovusdw_12() {
    run_test(
        ...
        &[98, 242, 126, 72, 19, 36, 221, 143, 222, 71, 7],
        OperandSize::Qword,
    )
}
