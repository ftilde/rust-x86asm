...
fn vfnmadd132ss_2() {
    run_test(
        ...
        &[196, 226, 89, 157, 154, 151, 132, 93, 21],
        OperandSize::Dword,
    )
}
...
fn vfnmadd132ss_4() {
    run_test(
        ...
        &[196, 226, 65, 157, 131, 140, 241, 213, 39],
        OperandSize::Qword,
    )
}
...
fn vfnmadd132ss_8() {
    run_test(
        ...
        &[98, 226, 93, 129, 157, 160, 17, 102, 220, 45],
        OperandSize::Qword,
    )
}
