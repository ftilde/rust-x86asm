...
fn vptestmb_4() {
    run_test(
        ...
        &[98, 242, 93, 5, 38, 12, 69, 42, 88, 70, 105],
        OperandSize::Qword,
    )
}
...
fn vptestmb_8() {
    run_test(
        ...
        &[98, 242, 29, 43, 38, 167, 178, 77, 12, 47],
        OperandSize::Qword,
    )
}
