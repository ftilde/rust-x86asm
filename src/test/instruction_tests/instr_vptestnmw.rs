...
fn vptestnmw_4() {
    run_test(
        ...
        &[98, 242, 206, 4, 38, 138, 87, 101, 186, 24],
        OperandSize::Qword,
    )
}
...
fn vptestnmw_6() {
    run_test(
        ...
        &[98, 242, 222, 45, 38, 36, 245, 39, 155, 55, 107],
        OperandSize::Dword,
    )
}
...
fn vptestnmw_10() {
    run_test(
        ...
        &[98, 242, 238, 77, 38, 178, 6, 126, 148, 1],
        OperandSize::Dword,
    )
}
...
fn vptestnmw_12() {
    run_test(
        ...
        &[98, 242, 206, 71, 38, 164, 71, 35, 110, 90, 44],
        OperandSize::Qword,
    )
}
