...
fn vpblendw_6() {
    run_test(
        ...
        &[196, 227, 125, 14, 44, 197, 227, 90, 36, 60, 87],
        OperandSize::Dword,
    )
}
...
fn vpblendw_8() {
    run_test(
        ...
        &[196, 227, 85, 14, 52, 125, 216, 45, 28, 32, 60],
        OperandSize::Qword,
    )
}
