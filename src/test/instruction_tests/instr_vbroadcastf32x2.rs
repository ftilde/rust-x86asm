...
fn vbroadcastf32x2_2() {
    run_test(
        ...
        &[98, 242, 125, 169, 25, 60, 205, 250, 94, 68, 20],
        OperandSize::Dword,
    )
}
...
fn vbroadcastf32x2_4() {
    run_test(
        ...
        &[98, 98, 125, 174, 25, 172, 67, 175, 82, 66, 32],
        OperandSize::Qword,
    )
}
...
fn vbroadcastf32x2_8() {
    run_test(
        ...
        &[98, 114, 125, 204, 25, 132, 134, 93, 70, 150, 113],
        OperandSize::Qword,
    )
}
