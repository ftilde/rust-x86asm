...
fn vpminuw_2() {
    run_test(
        ...
        &[196, 226, 81, 58, 36, 253, 47, 7, 245, 109],
        OperandSize::Dword,
    )
}
...
fn vpminuw_4() {
    run_test(
        ...
        &[196, 226, 65, 58, 140, 142, 182, 213, 32, 58],
        OperandSize::Qword,
    )
}
...
fn vpminuw_10() {
    run_test(
        ...
        &[98, 242, 93, 137, 58, 164, 143, 1, 84, 159, 57],
        OperandSize::Dword,
    )
}
...
fn vpminuw_14() {
    run_test(
        ...
        &[98, 242, 101, 173, 58, 152, 235, 80, 224, 89],
        OperandSize::Dword,
    )
}
...
fn vpminuw_18() {
    run_test(
        ...
        &[98, 242, 85, 201, 58, 148, 82, 189, 47, 99, 61],
        OperandSize::Dword,
    )
}
...
fn vpminuw_20() {
    run_test(
        ...
        &[98, 226, 117, 193, 58, 190, 61, 13, 57, 117],
        OperandSize::Qword,
    )
}
