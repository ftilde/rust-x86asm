...
fn vfmaddsub213pd_2() {
    run_test(
        ...
        &[196, 226, 217, 166, 52, 245, 197, 3, 235, 18],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213pd_6() {
    run_test(
        ...
        &[196, 226, 221, 166, 28, 197, 181, 104, 186, 107],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213pd_8() {
    run_test(
        ...
        &[196, 226, 229, 166, 12, 253, 62, 213, 76, 60],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub213pd_10() {
    run_test(
        ...
        &[98, 242, 213, 142, 166, 52, 85, 88, 144, 122, 59],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213pd_16() {
    run_test(
        ...
        &[98, 242, 197, 170, 166, 168, 134, 127, 135, 104],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213pd_17() {
    run_test(
        ...
        &[98, 242, 205, 187, 166, 187, 41, 99, 68, 118],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213pd_19() {
    run_test(
        ...
        &[98, 98, 229, 165, 166, 180, 131, 4, 130, 38, 88],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub213pd_25() {
    run_test(
        ...
        &[98, 226, 141, 198, 166, 178, 134, 225, 63, 90],
        OperandSize::Qword,
    )
}
