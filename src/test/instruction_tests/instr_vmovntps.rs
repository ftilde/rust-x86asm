...
fn vmovntps_1() {
    run_test(
        ...
        &[197, 248, 43, 28, 197, 154, 37, 129, 70],
        OperandSize::Dword,
    )
}
...
fn vmovntps_6() {
    run_test(
        ...
        &[98, 97, 124, 8, 43, 155, 184, 110, 13, 62],
        OperandSize::Qword,
    )
}
...
fn vmovntps_7() {
    run_test(
        &Instruction {
            mnemonic: Mnemonic::VMOVNTPS,
            operand1: Some(Indirect(EBX, Some(OperandSize::Ymmword), None)),
            operand2: Some(Direct(YMM7)),
            operand3: None,
            operand4: None,
            lock: false,
...
fn vmovntps_8() {
    run_test(
        ...
        &[98, 97, 124, 40, 43, 52, 149, 189, 198, 200, 117],
        OperandSize::Qword,
    )
}
...
fn vmovntps_9() {
    run_test(
        ...
        &[98, 241, 124, 72, 43, 132, 191, 63, 176, 35, 79],
        OperandSize::Dword,
    )
}
...
fn vmovntps_10() {
    run_test(
        ...
        &[98, 241, 124, 72, 43, 60, 77, 239, 89, 47, 105],
        OperandSize::Qword,
    )
}
