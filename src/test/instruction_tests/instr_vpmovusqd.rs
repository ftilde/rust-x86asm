...
fn vpmovusqd_4() {
    run_test(
        ...
        &[98, 226, 126, 8, 21, 159, 178, 245, 57, 97],
        OperandSize::Qword,
    )
}
...
fn vpmovusqd_6() {
    run_test(
        ...
        &[98, 242, 126, 40, 21, 28, 221, 115, 104, 115, 69],
        OperandSize::Dword,
    )
}
...
fn vpmovusqd_8() {
    run_test(
        ...
        &[98, 242, 126, 40, 21, 12, 189, 152, 118, 77, 56],
        OperandSize::Qword,
    )
}
...
fn vpmovusqd_10() {
    run_test(
        ...
        &[98, 242, 126, 72, 21, 60, 85, 202, 62, 215, 52],
        OperandSize::Dword,
    )
}
...
fn vpmovusqd_12() {
    run_test(
        &Instruction {
            mnemonic: Mnemonic::VPMOVUSQD,
            operand1: Some(Indirect(RDI, Some(OperandSize::Ymmword), None)),
