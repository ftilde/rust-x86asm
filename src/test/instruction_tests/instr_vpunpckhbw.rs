...
fn vpunpckhbw_2() {
    run_test(
        ...
        &[197, 233, 104, 132, 90, 53, 179, 27, 50],
        OperandSize::Dword,
    )
}
...
fn vpunpckhbw_4() {
    run_test(
        ...
        &[197, 249, 104, 132, 83, 174, 158, 90, 58],
        OperandSize::Qword,
    )
}
...
fn vpunpckhbw_12() {
    run_test(
        ...
        &[98, 113, 69, 140, 104, 188, 154, 43, 73, 162, 43],
        OperandSize::Qword,
    )
}
