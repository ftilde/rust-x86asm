...
fn vminpd_4() {
    run_test(
        ...
        &[197, 233, 93, 36, 221, 244, 242, 173, 3],
        OperandSize::Qword,
    )
}
...
fn vminpd_8() {
    run_test(
        ...
        &[197, 253, 93, 172, 137, 16, 142, 174, 113],
        OperandSize::Qword,
    )
}
...
fn vminpd_10() {
    run_test(
        ...
        &[98, 241, 229, 138, 93, 183, 137, 144, 157, 57],
        OperandSize::Dword,
    )
}
...
fn vminpd_13() {
    run_test(
        ...
        &[98, 225, 157, 129, 93, 148, 209, 15, 27, 66, 73],
        OperandSize::Qword,
    )
}
...
fn vminpd_14() {
    run_test(
        ...
        &[98, 225, 173, 157, 93, 148, 209, 218, 207, 236, 6],
        OperandSize::Qword,
    )
}
...
fn vminpd_17() {
    run_test(
        ...
        &[98, 241, 205, 186, 93, 20, 117, 84, 220, 133, 70],
        OperandSize::Dword,
    )
}
...
fn vminpd_23() {
    run_test(
        ...
        &[98, 241, 197, 220, 93, 187, 198, 194, 184, 103],
        OperandSize::Dword,
    )
}
...
fn vminpd_25() {
    run_test(
        ...
        &[98, 225, 245, 194, 93, 184, 105, 219, 213, 111],
        OperandSize::Qword,
    )
}
...
fn vminpd_26() {
    run_test(
        ...
        &[98, 241, 229, 222, 93, 164, 115, 151, 94, 6, 15],
        OperandSize::Qword,
    )
}
