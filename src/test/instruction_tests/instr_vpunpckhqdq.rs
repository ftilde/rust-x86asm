...
fn vpunpckhqdq_4() {
    run_test(
        ...
        &[197, 225, 109, 172, 158, 13, 244, 153, 123],
        OperandSize::Qword,
    )
}
...
fn vpunpckhqdq_8() {
    run_test(
        ...
        &[197, 197, 109, 20, 77, 127, 69, 184, 99],
        OperandSize::Qword,
    )
}
...
fn vpunpckhqdq_10() {
    run_test(
        ...
        &[98, 241, 237, 140, 109, 20, 149, 219, 67, 10, 55],
        OperandSize::Dword,
    )
}
