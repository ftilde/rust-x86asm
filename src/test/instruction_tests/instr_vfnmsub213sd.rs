...
fn vfnmsub213sd_2() {
    run_test(
        ...
        &[196, 226, 217, 175, 60, 85, 223, 126, 18, 79],
        OperandSize::Dword,
    )
}
...
fn vfnmsub213sd_4() {
    run_test(
        ...
        &[196, 226, 193, 175, 20, 253, 39, 16, 211, 74],
        OperandSize::Qword,
    )
}
...
fn vfnmsub213sd_8() {
    run_test(
        ...
        &[98, 242, 181, 135, 175, 146, 102, 105, 184, 126],
        OperandSize::Qword,
    )
}
