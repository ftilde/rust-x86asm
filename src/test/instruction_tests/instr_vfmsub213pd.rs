...
fn vfmsub213pd_4() {
    run_test(
        &Instruction {
            ...
            operand3: Some(Indirect(RCX, Some(OperandSize::Xmmword), None)),
            operand4: None,
            lock: false,
            rounding_mode: None,
            merge_mode: None,
...
fn vfmsub213pd_10() {
    run_test(
        ...
        &[98, 242, 237, 138, 170, 140, 146, 20, 112, 93, 89],
        OperandSize::Dword,
    )
}
...
fn vfmsub213pd_11() {
    run_test(
        ...
        &[98, 242, 205, 159, 170, 188, 208, 9, 166, 71, 99],
        OperandSize::Dword,
    )
}
...
fn vfmsub213pd_14() {
    run_test(
        ...
        &[98, 242, 165, 159, 170, 129, 4, 33, 112, 74],
        OperandSize::Qword,
    )
}
...
fn vfmsub213pd_16() {
    run_test(
        ...
        &[98, 242, 197, 171, 170, 12, 157, 53, 245, 213, 55],
        OperandSize::Dword,
    )
}
...
fn vfmsub213pd_23() {
    run_test(
        ...
        &[98, 242, 245, 217, 170, 132, 203, 48, 22, 42, 38],
        OperandSize::Dword,
    )
}
...
fn vfmsub213pd_25() {
    run_test(
        ...
        &[98, 242, 165, 196, 170, 131, 186, 162, 153, 51],
        OperandSize::Qword,
    )
}
...
fn vfmsub213pd_26() {
    run_test(
        ...
        &[98, 98, 149, 218, 170, 188, 80, 51, 44, 108, 111],
        OperandSize::Qword,
    )
}
