...
fn vpsrlvw_10() {
    run_test(
        ...
        &[98, 242, 221, 206, 16, 172, 241, 187, 130, 253, 0],
        OperandSize::Dword,
    )
}
...
fn vpsrlvw_12() {
    run_test(
        ...
        &[98, 242, 157, 198, 16, 132, 206, 31, 15, 223, 108],
        OperandSize::Qword,
    )
}
