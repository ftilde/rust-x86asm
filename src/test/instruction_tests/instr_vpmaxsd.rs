...
fn vpmaxsd_6() {
    run_test(
        ...
        &[196, 226, 117, 61, 36, 253, 94, 78, 117, 94],
        OperandSize::Dword,
    )
}
...
fn vpmaxsd_8() {
    run_test(
        ...
        &[196, 226, 85, 61, 166, 255, 168, 2, 78],
        OperandSize::Qword,
    )
}
...
fn vpmaxsd_10() {
    run_test(
        ...
        &[98, 242, 93, 137, 61, 131, 49, 36, 158, 39],
        OperandSize::Dword,
    )
}
...
fn vpmaxsd_11() {
    run_test(
        ...
        &[98, 242, 109, 156, 61, 36, 93, 246, 155, 81, 4],
        OperandSize::Dword,
    )
}
