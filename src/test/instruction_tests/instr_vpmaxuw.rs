...
fn vpmaxuw_2() {
    run_test(
        ...
        &[196, 226, 81, 62, 140, 178, 102, 74, 49, 124],
        OperandSize::Dword,
    )
}
...
fn vpmaxuw_6() {
    run_test(
        ...
        &[196, 226, 109, 62, 164, 145, 75, 101, 191, 1],
        OperandSize::Dword,
    )
}
...
fn vpmaxuw_16() {
    run_test(
        ...
        &[98, 226, 77, 166, 62, 4, 213, 46, 223, 93, 51],
        OperandSize::Qword,
    )
}
...
fn vpmaxuw_18() {
    run_test(
        ...
        &[98, 242, 109, 207, 62, 156, 146, 109, 63, 27, 16],
        OperandSize::Dword,
    )
}
...
fn vpmaxuw_20() {
    run_test(
        ...
        &[98, 114, 29, 205, 62, 134, 18, 3, 116, 67],
        OperandSize::Qword,
    )
}
