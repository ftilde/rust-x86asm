...
fn vmovhps_1() {
    run_test(
        ...
        &[197, 240, 22, 148, 145, 237, 121, 80, 25],
        OperandSize::Dword,
    )
}
...
fn vmovhps_3() {
    run_test(
        ...
        &[197, 224, 22, 180, 215, 161, 100, 173, 25],
        OperandSize::Dword,
    )
}
...
fn vmovhps_5() {
    run_test(
        ...
        &[197, 248, 23, 182, 161, 240, 166, 101],
        OperandSize::Dword,
    )
}
...
fn vmovhps_6() {
    run_test(
        ...
        &[197, 248, 23, 52, 77, 247, 254, 200, 97],
        OperandSize::Qword,
    )
}
