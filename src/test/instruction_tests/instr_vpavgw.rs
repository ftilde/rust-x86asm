...
fn vpavgw_4() {
    run_test(
        ...
        &[197, 225, 227, 188, 203, 255, 134, 56, 35],
        OperandSize::Qword,
    )
}
...
fn vpavgw_8() {
    run_test(
        ...
        &[197, 237, 227, 164, 120, 129, 134, 220, 65],
        OperandSize::Qword,
    )
}
...
fn vpavgw_10() {
    run_test(
        ...
        &[98, 241, 85, 140, 227, 12, 245, 38, 61, 87, 21],
        OperandSize::Dword,
    )
}
...
fn vpavgw_12() {
    run_test(
        ...
        &[98, 97, 61, 135, 227, 4, 77, 113, 17, 157, 18],
        OperandSize::Qword,
    )
}
...
fn vpavgw_20() {
    run_test(
        ...
        &[98, 113, 117, 196, 227, 188, 89, 218, 133, 235, 23],
        OperandSize::Qword,
    )
}
