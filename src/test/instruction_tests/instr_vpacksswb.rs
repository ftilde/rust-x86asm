...
fn vpacksswb_2() {
    run_test(
        ...
        &[197, 193, 99, 44, 205, 177, 218, 203, 10],
        OperandSize::Dword,
    )
}
...
fn vpacksswb_4() {
    run_test(
        ...
        &[197, 233, 99, 156, 219, 79, 240, 15, 103],
        OperandSize::Qword,
    )
}
...
fn vpacksswb_6() {
    run_test(
        ...
        &[197, 253, 99, 164, 119, 230, 67, 152, 100],
        OperandSize::Dword,
    )
}
...
fn vpacksswb_8() {
    run_test(
        ...
        &[197, 237, 99, 172, 201, 156, 211, 231, 69],
        OperandSize::Qword,
    )
}
...
fn vpacksswb_16() {
    run_test(
        ...
        &[98, 241, 85, 167, 99, 4, 93, 73, 57, 164, 29],
        OperandSize::Qword,
    )
}
