...
fn vpminsb_2() {
    run_test(
        ...
        &[196, 226, 121, 56, 129, 229, 2, 67, 80],
        OperandSize::Dword,
    )
}
...
fn vpminsb_12() {
    run_test(
        ...
        &[98, 114, 37, 138, 56, 12, 117, 203, 19, 219, 28],
        OperandSize::Qword,
    )
}
...
fn vpminsb_18() {
    run_test(
        ...
        &[98, 242, 109, 207, 56, 164, 88, 64, 214, 88, 89],
        OperandSize::Dword,
    )
}
...
fn vpminsb_20() {
    run_test(
        ...
        &[98, 242, 117, 204, 56, 132, 201, 16, 195, 22, 92],
        OperandSize::Qword,
    )
}
