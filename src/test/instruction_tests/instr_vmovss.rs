...
fn vmovss_3() {
    run_test(
        ...
        &[197, 250, 16, 36, 197, 195, 112, 132, 19],
        OperandSize::Dword,
    )
}
...
fn vmovss_7() {
    run_test(
        ...
        &[98, 241, 126, 137, 16, 36, 141, 23, 253, 12, 103],
        OperandSize::Dword,
    )
}
