...
fn vfmadd132sd_2() {
    run_test(
        ...
        &[196, 226, 249, 153, 44, 69, 83, 18, 10, 91],
        OperandSize::Dword,
    )
}
...
fn vfmadd132sd_6() {
    run_test(
        ...
        &[98, 242, 221, 137, 153, 156, 186, 180, 107, 170, 91],
        OperandSize::Dword,
    )
}
...
fn vfmadd132sd_8() {
    run_test(
        ...
        &[98, 114, 141, 139, 153, 12, 117, 165, 62, 131, 72],
        OperandSize::Qword,
    )
}
