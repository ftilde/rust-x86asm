...
fn vpmovusqw_4() {
    run_test(
        ...
        &[98, 242, 126, 8, 20, 131, 116, 194, 64, 72],
        OperandSize::Qword,
    )
}
...
fn vpmovusqw_6() {
    run_test(
        ...
        &[98, 242, 126, 40, 20, 44, 221, 236, 117, 165, 115],
        OperandSize::Dword,
    )
}
...
fn vpmovusqw_10() {
    run_test(
        ...
        &[98, 242, 126, 72, 20, 156, 87, 123, 45, 97, 95],
        OperandSize::Dword,
    )
}
...
fn vpmovusqw_12() {
    run_test(
        ...
        &[98, 98, 126, 72, 20, 175, 162, 222, 88, 106],
        OperandSize::Qword,
    )
}
