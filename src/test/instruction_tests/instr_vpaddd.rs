...
fn vpaddd_4() {
    run_test(
        ...
        &[197, 241, 254, 180, 209, 76, 223, 74, 40],
        OperandSize::Qword,
    )
}
...
fn vpaddd_6() {
    run_test(
        ...
        &[197, 221, 254, 20, 189, 6, 14, 117, 56],
        OperandSize::Dword,
    )
}
...
fn vpaddd_11() {
    run_test(
        ...
        &[98, 241, 109, 158, 254, 28, 93, 38, 73, 230, 68],
        OperandSize::Dword,
    )
}
...
fn vpaddd_14() {
    run_test(
        ...
        &[98, 97, 109, 157, 254, 156, 72, 80, 82, 50, 40],
        OperandSize::Qword,
    )
}
