...
fn vpshufb_6() {
    run_test(
        ...
        &[196, 226, 69, 0, 164, 249, 249, 3, 59, 112],
        OperandSize::Dword,
    )
}
...
fn vpshufb_10() {
    run_test(
        ...
        &[98, 242, 101, 137, 0, 132, 184, 155, 197, 61, 127],
        OperandSize::Dword,
    )
}
...
fn vpshufb_18() {
    run_test(
        ...
        &[98, 242, 93, 202, 0, 20, 157, 154, 175, 218, 52],
        OperandSize::Dword,
    )
}
...
fn vpshufb_20() {
    run_test(
        ...
        &[98, 226, 93, 193, 0, 20, 245, 87, 188, 119, 7],
        OperandSize::Qword,
    )
}
