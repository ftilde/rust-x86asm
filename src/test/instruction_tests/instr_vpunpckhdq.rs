...
fn vpunpckhdq_8() {
    run_test(
        ...
        &[197, 237, 106, 44, 117, 180, 59, 62, 120],
        OperandSize::Qword,
    )
}
...
fn vpunpckhdq_10() {
    run_test(
        ...
        &[98, 241, 77, 139, 106, 128, 116, 126, 225, 26],
        OperandSize::Dword,
    )
}
...
fn vpunpckhdq_11() {
    run_test(
        ...
        &[98, 241, 85, 153, 106, 12, 125, 39, 230, 213, 45],
        OperandSize::Dword,
    )
}
