...
fn vfnmsub132ss_2() {
    run_test(
        ...
        &[196, 226, 97, 159, 162, 199, 167, 90, 41],
        OperandSize::Dword,
    )
}
...
fn vfnmsub132ss_4() {
    run_test(
        ...
        &[196, 226, 105, 159, 60, 181, 107, 62, 125, 65],
        OperandSize::Qword,
    )
}
