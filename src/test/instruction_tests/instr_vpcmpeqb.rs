...
fn vpcmpeqb_2() {
    run_test(
        ...
        &[197, 249, 116, 182, 185, 216, 253, 102],
        OperandSize::Dword,
    )
}
...
fn vpcmpeqb_10() {
    run_test(
        ...
        &[98, 241, 109, 12, 116, 172, 123, 113, 124, 133, 51],
        OperandSize::Dword,
    )
}
...
fn vpcmpeqb_16() {
    run_test(
        ...
        &[98, 241, 69, 33, 116, 150, 223, 213, 137, 40],
        OperandSize::Qword,
    )
}
...
fn vpcmpeqb_20() {
    run_test(
        ...
        &[98, 241, 5, 73, 116, 20, 197, 140, 65, 98, 94],
        OperandSize::Qword,
    )
}
