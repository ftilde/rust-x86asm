...
fn vptestmd_2() {
    run_test(
        ...
        &[98, 242, 125, 13, 39, 142, 112, 232, 209, 3],
        OperandSize::Dword,
    )
}
...
fn vptestmd_3() {
    run_test(
        ...
        &[98, 242, 125, 31, 39, 164, 120, 76, 55, 190, 13],
        OperandSize::Dword,
    )
}
...
fn vptestmd_6() {
    run_test(
        ...
        &[98, 242, 29, 28, 39, 145, 177, 182, 160, 107],
        OperandSize::Qword,
    )
}
...
fn vptestmd_8() {
    run_test(
        ...
        &[98, 242, 93, 41, 39, 20, 93, 118, 228, 253, 38],
        OperandSize::Dword,
    )
}
...
fn vptestmd_9() {
    run_test(
        ...
        &[98, 242, 93, 62, 39, 139, 160, 126, 123, 38],
        OperandSize::Dword,
    )
}
...
fn vptestmd_12() {
    run_test(
        ...
        &[98, 242, 101, 50, 39, 52, 245, 64, 146, 19, 103],
        OperandSize::Qword,
    )
}
...
fn vptestmd_15() {
    run_test(
        ...
        &[98, 242, 77, 89, 39, 148, 79, 187, 227, 233, 55],
        OperandSize::Dword,
    )
}
