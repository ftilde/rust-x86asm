...
fn vpabsb_2() {
    run_test(
        ...
        &[196, 226, 121, 28, 60, 245, 86, 218, 146, 78],
        OperandSize::Dword,
    )
}
...
fn vpabsb_6() {
    run_test(
        ...
        &[196, 226, 125, 28, 20, 253, 223, 254, 142, 16],
        OperandSize::Dword,
    )
}
...
fn vpabsb_10() {
    run_test(
        ...
        &[98, 242, 125, 139, 28, 172, 144, 210, 194, 183, 100],
        OperandSize::Dword,
    )
}
...
fn vpabsb_12() {
    run_test(
        ...
        &[98, 242, 125, 141, 28, 44, 213, 167, 80, 24, 57],
        OperandSize::Qword,
    )
}
