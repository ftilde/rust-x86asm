...
fn vpcmpgtw_6() {
    run_test(
        ...
        &[197, 205, 101, 131, 117, 233, 167, 36],
        OperandSize::Dword,
    )
}
...
fn vpcmpgtw_10() {
    run_test(
        ...
        &[98, 241, 69, 14, 101, 12, 205, 80, 119, 10, 42],
        OperandSize::Dword,
    )
}
...
fn vpcmpgtw_12() {
    run_test(
        ...
        &[98, 241, 101, 3, 101, 156, 137, 133, 104, 79, 15],
        OperandSize::Qword,
    )
}
...
fn vpcmpgtw_16() {
    run_test(
        ...
        &[98, 241, 13, 37, 101, 144, 146, 75, 104, 16],
        OperandSize::Qword,
    )
}
...
fn vpcmpgtw_18() {
    run_test(
        ...
        &[98, 241, 109, 74, 101, 170, 242, 71, 237, 19],
        OperandSize::Dword,
    )
}
