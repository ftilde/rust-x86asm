...
fn vmaxsd_4() {
    run_test(
        ...
        &[197, 203, 95, 20, 221, 135, 55, 99, 15],
        OperandSize::Qword,
    )
}
...
fn vmaxsd_6() {
    run_test(
        ...
        &[98, 241, 247, 139, 95, 184, 204, 157, 192, 40],
        OperandSize::Dword,
    )
}
