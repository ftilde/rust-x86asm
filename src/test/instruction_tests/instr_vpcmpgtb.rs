...
fn vpcmpgtb_2() {
    run_test(
        ...
        &[197, 241, 100, 180, 152, 84, 141, 240, 5],
        OperandSize::Dword,
    )
}
...
fn vpcmpgtb_4() {
    run_test(
        ...
        &[197, 225, 100, 171, 156, 123, 204, 71],
        OperandSize::Qword,
    )
}
...
fn vpcmpgtb_6() {
    run_test(
        ...
        &[197, 229, 100, 4, 189, 30, 244, 220, 66],
        OperandSize::Dword,
    )
}
...
fn vpcmpgtb_10() {
    run_test(
        ...
        &[98, 241, 93, 13, 100, 183, 24, 199, 137, 50],
        OperandSize::Dword,
    )
}
...
fn vpcmpgtb_12() {
    run_test(
        ...
        &[98, 241, 37, 4, 100, 28, 141, 53, 170, 185, 37],
        OperandSize::Qword,
    )
}
...
fn vpcmpgtb_16() {
    run_test(
        ...
        &[98, 241, 117, 46, 100, 148, 81, 8, 86, 182, 110],
        OperandSize::Qword,
    )
}
