...
fn vfmsubadd213ps_2() {
    run_test(
        ...
        &[196, 226, 89, 167, 36, 141, 73, 248, 121, 127],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd213ps_6() {
    run_test(
        ...
        &[196, 226, 93, 167, 180, 139, 74, 56, 144, 74],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd213ps_8() {
    run_test(
        &Instruction {
            ...
            operand3: Some(Indirect(RCX, Some(OperandSize::Ymmword), None)),
            operand4: None,
            lock: false,
            rounding_mode: None,
            merge_mode: None,
...
fn vfmsubadd213ps_10() {
    run_test(
        ...
        &[98, 242, 101, 137, 167, 143, 69, 235, 92, 115],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd213ps_11() {
    run_test(
        ...
        &[98, 242, 77, 156, 167, 174, 245, 110, 120, 81],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd213ps_13() {
    run_test(
        ...
        &[98, 242, 109, 139, 167, 146, 206, 71, 116, 55],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd213ps_14() {
    run_test(
        ...
        &[98, 242, 37, 149, 167, 4, 205, 66, 203, 68, 94],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd213ps_17() {
    run_test(
        ...
        &[98, 242, 101, 190, 167, 20, 93, 225, 19, 30, 75],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd213ps_19() {
    run_test(
        ...
        &[98, 114, 117, 162, 167, 129, 10, 126, 132, 9],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd213ps_20() {
    run_test(
        ...
        &[98, 226, 85, 188, 167, 162, 206, 9, 124, 22],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd213ps_23() {
    run_test(
        ...
        &[98, 242, 69, 219, 167, 132, 130, 99, 218, 98, 76],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd213ps_26() {
    run_test(
        ...
        &[98, 114, 117, 209, 167, 158, 114, 74, 236, 60],
        OperandSize::Qword,
    )
}
