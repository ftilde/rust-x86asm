...
fn vfnmsub231sd_2() {
    run_test(
        ...
        &[196, 226, 193, 191, 28, 77, 29, 144, 173, 8],
        OperandSize::Dword,
    )
}
...
fn vfnmsub231sd_4() {
    run_test(
        ...
        &[196, 226, 209, 191, 148, 184, 191, 3, 35, 65],
        OperandSize::Qword,
    )
}
