...
fn vfmaddsub231ps_4() {
    run_test(
        ...
        &[196, 226, 113, 182, 145, 124, 153, 165, 12],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231ps_6() {
    run_test(
        ...
        &[196, 226, 69, 182, 156, 158, 203, 131, 156, 24],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231ps_8() {
    run_test(
        ...
        &[196, 226, 93, 182, 180, 130, 173, 168, 9, 29],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231ps_10() {
    run_test(
        ...
        &[98, 242, 77, 141, 182, 164, 248, 239, 84, 13, 84],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231ps_13() {
    run_test(
        ...
        &[98, 226, 85, 137, 182, 12, 77, 61, 135, 74, 112],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231ps_16() {
    run_test(
        ...
        &[98, 242, 125, 172, 182, 174, 224, 186, 167, 41],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231ps_20() {
    run_test(
        ...
        &[98, 98, 85, 178, 182, 172, 159, 228, 76, 143, 91],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231ps_22() {
    run_test(
        ...
        &[98, 242, 85, 201, 182, 36, 125, 225, 164, 103, 69],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231ps_23() {
    run_test(
        ...
        &[98, 242, 77, 219, 182, 172, 194, 219, 39, 15, 27],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231ps_25() {
    run_test(
        ...
        &[98, 226, 37, 196, 182, 140, 138, 179, 215, 188, 62],
        OperandSize::Qword,
    )
}
