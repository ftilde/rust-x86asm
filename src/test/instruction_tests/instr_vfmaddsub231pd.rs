...
fn vfmaddsub231pd_2() {
    run_test(
        ...
        &[196, 226, 241, 182, 166, 152, 223, 230, 99],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231pd_4() {
    run_test(
        ...
        &[196, 226, 225, 182, 28, 93, 120, 61, 177, 55],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231pd_6() {
    run_test(
        ...
        &[196, 226, 221, 182, 20, 85, 15, 74, 255, 123],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231pd_8() {
    run_test(
        ...
        &[196, 226, 213, 182, 174, 179, 69, 135, 19],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231pd_10() {
    run_test(
        ...
        &[98, 242, 237, 141, 182, 44, 77, 84, 215, 227, 12],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231pd_11() {
    run_test(
        ...
        &[98, 242, 221, 153, 182, 164, 138, 114, 48, 254, 58],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231pd_13() {
    run_test(
        ...
        &[98, 242, 197, 137, 182, 44, 245, 199, 40, 52, 95],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231pd_14() {
    run_test(
        &Instruction {
            ...
            operand3: Some(Indirect(RSI, Some(OperandSize::Qword), None)),
            operand4: None,
            lock: false,
            rounding_mode: None,
            merge_mode: Some(MergeMode::Zero),
...
fn vfmaddsub231pd_17() {
    run_test(
        ...
        &[98, 242, 213, 190, 182, 60, 245, 124, 217, 204, 47],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub231pd_19() {
    run_test(
        ...
        &[98, 114, 157, 161, 182, 132, 186, 26, 65, 216, 34],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231pd_20() {
    run_test(
        ...
        &[98, 98, 245, 183, 182, 188, 73, 140, 198, 253, 116],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231pd_25() {
    run_test(
        ...
        &[98, 114, 157, 195, 182, 144, 104, 102, 68, 6],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub231pd_26() {
    run_test(
        ...
        &[98, 114, 133, 210, 182, 28, 205, 34, 91, 175, 101],
        OperandSize::Qword,
    )
}
