...
fn vfmadd132ss_2() {
    run_test(
        ...
        &[196, 226, 105, 153, 12, 149, 26, 161, 2, 21],
        OperandSize::Dword,
    )
}
...
fn vfmadd132ss_4() {
    run_test(
        ...
        &[196, 226, 73, 153, 137, 133, 122, 178, 98],
        OperandSize::Qword,
    )
}
