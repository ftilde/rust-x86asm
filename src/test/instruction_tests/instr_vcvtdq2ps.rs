...
fn vcvtdq2ps_8() {
    run_test(
        ...
        &[197, 252, 91, 36, 253, 149, 251, 65, 120],
        OperandSize::Qword,
    )
}
...
fn vcvtdq2ps_12() {
    run_test(
        ...
        &[98, 241, 124, 139, 91, 36, 125, 209, 76, 179, 77],
        OperandSize::Qword,
    )
}
...
fn vcvtdq2ps_14() {
    run_test(
        ...
        &[98, 241, 124, 174, 91, 20, 181, 175, 186, 47, 115],
        OperandSize::Dword,
    )
}
...
fn vcvtdq2ps_16() {
    run_test(
        ...
        &[98, 97, 124, 169, 91, 180, 219, 209, 71, 109, 124],
        OperandSize::Qword,
    )
}
