...
fn vpcmpgtd_14() {
    run_test(
        ...
        &[98, 241, 109, 22, 102, 36, 221, 171, 54, 98, 11],
        OperandSize::Qword,
    )
}
...
fn vpcmpgtd_16() {
    run_test(
        ...
        &[98, 241, 125, 44, 102, 28, 93, 237, 255, 12, 69],
        OperandSize::Dword,
    )
}
...
fn vpcmpgtd_17() {
    run_test(
        ...
        &[98, 241, 93, 58, 102, 180, 176, 29, 52, 11, 31],
        OperandSize::Dword,
    )
}
...
fn vpcmpgtd_19() {
    run_test(
        ...
        &[98, 241, 37, 41, 102, 140, 146, 195, 136, 185, 81],
        OperandSize::Qword,
    )
}
...
fn vpcmpgtd_20() {
    run_test(
        ...
        &[98, 241, 53, 50, 102, 183, 148, 116, 255, 99],
        OperandSize::Qword,
    )
}
...
fn vpcmpgtd_22() {
    run_test(
        ...
        &[98, 241, 125, 76, 102, 180, 142, 99, 167, 219, 82],
        OperandSize::Dword,
    )
}
...
fn vpcmpgtd_23() {
    run_test(
        ...
        &[98, 241, 69, 95, 102, 180, 216, 134, 99, 48, 32],
        OperandSize::Dword,
    )
}
...
fn vpcmpgtd_25() {
    run_test(
        ...
        &[98, 241, 37, 70, 102, 170, 32, 109, 91, 10],
        OperandSize::Qword,
    )
}
...
fn vpcmpgtd_26() {
    run_test(
        ...
        &[98, 241, 61, 94, 102, 20, 197, 210, 242, 204, 73],
        OperandSize::Qword,
    )
}
