...
fn vfmaddsub132pd_8() {
    run_test(
        ...
        &[196, 226, 229, 150, 180, 74, 5, 100, 224, 58],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub132pd_11() {
    run_test(
        ...
        &[98, 242, 221, 156, 150, 177, 33, 161, 123, 40],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub132pd_13() {
    run_test(
        ...
        &[98, 242, 157, 137, 150, 164, 135, 193, 89, 163, 82],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub132pd_17() {
    run_test(
        ...
        &[98, 242, 253, 190, 150, 20, 149, 86, 122, 197, 29],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub132pd_20() {
    run_test(
        ...
        &[98, 242, 189, 187, 150, 187, 100, 156, 46, 43],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub132pd_22() {
    run_test(
        ...
        &[98, 242, 205, 203, 150, 44, 125, 176, 171, 57, 60],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub132pd_25() {
    run_test(
        ...
        &[98, 98, 157, 204, 150, 36, 141, 181, 217, 24, 90],
        OperandSize::Qword,
    )
}
