...
fn vpmovsqd_4() {
    run_test(
        ...
        &[98, 242, 126, 8, 37, 20, 125, 48, 145, 141, 37],
        OperandSize::Qword,
    )
}
...
fn vpmovsqd_6() {
    run_test(
        ...
        &[98, 242, 126, 40, 37, 174, 55, 190, 10, 115],
        OperandSize::Dword,
    )
}
...
fn vpmovsqd_8() {
    run_test(
        ...
        &[98, 242, 126, 40, 37, 171, 91, 150, 62, 33],
        OperandSize::Qword,
    )
}
...
fn vpmovsqd_10() {
    run_test(
        ...
        &[98, 242, 126, 72, 37, 182, 78, 4, 194, 38],
        OperandSize::Dword,
    )
}
