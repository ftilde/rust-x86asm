...
fn vfmadd231ss_2() {
    run_test(
        ...
        &[196, 226, 89, 185, 60, 117, 68, 183, 121, 93],
        OperandSize::Dword,
    )
}
...
fn vfmadd231ss_4() {
    run_test(
        ...
        &[196, 226, 97, 185, 147, 105, 251, 138, 21],
        OperandSize::Qword,
    )
}
...
fn vfmadd231ss_6() {
    run_test(
        ...
        &[98, 242, 85, 139, 185, 4, 133, 153, 209, 222, 55],
        OperandSize::Dword,
    )
}
...
fn vfmadd231ss_8() {
    run_test(
        ...
        &[98, 242, 117, 131, 185, 132, 199, 252, 72, 148, 52],
        OperandSize::Qword,
    )
}
