...
fn vsubsd_2() {
    run_test(
        ...
        &[197, 219, 92, 132, 142, 15, 65, 231, 78],
        OperandSize::Dword,
    )
}
...
fn vsubsd_6() {
    run_test(
        ...
        &[98, 241, 255, 138, 92, 60, 197, 223, 181, 242, 78],
        OperandSize::Dword,
    )
}
...
fn vsubsd_8() {
    run_test(
        ...
        &[98, 241, 191, 139, 92, 4, 181, 163, 229, 114, 20],
        OperandSize::Qword,
    )
}
