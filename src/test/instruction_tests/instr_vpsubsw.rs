...
fn vpsubsw_4() {
    run_test(
        ...
        &[197, 209, 233, 152, 217, 158, 121, 24],
        OperandSize::Qword,
    )
}
...
fn vpsubsw_12() {
    run_test(
        ...
        &[98, 97, 77, 141, 233, 180, 250, 196, 113, 154, 113],
        OperandSize::Qword,
    )
}
...
fn vpsubsw_14() {
    run_test(
        ...
        &[98, 241, 125, 174, 233, 137, 173, 128, 229, 61],
        OperandSize::Dword,
    )
}
...
fn vpsubsw_16() {
    run_test(
        ...
        &[98, 225, 77, 167, 233, 36, 69, 138, 243, 0, 90],
        OperandSize::Qword,
    )
}
