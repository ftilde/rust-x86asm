...
fn vpunpckldq_6() {
    run_test(
        ...
        &[197, 205, 98, 140, 185, 51, 221, 242, 99],
        OperandSize::Dword,
    )
}
...
fn vpunpckldq_10() {
    run_test(
        ...
        &[98, 241, 101, 140, 98, 164, 135, 230, 249, 85, 106],
        OperandSize::Dword,
    )
}
...
fn vpunpckldq_13() {
    run_test(
        ...
        &[98, 113, 69, 140, 98, 60, 93, 102, 18, 133, 119],
        OperandSize::Qword,
    )
}
