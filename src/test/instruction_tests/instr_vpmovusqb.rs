...
fn vpmovusqb_8() {
    run_test(
        ...
        &[98, 242, 126, 40, 18, 180, 223, 188, 155, 69, 110],
        OperandSize::Qword,
    )
}
...
fn vpmovusqb_10() {
    run_test(
        ...
        &[98, 242, 126, 72, 18, 132, 75, 119, 85, 62, 0],
        OperandSize::Dword,
    )
}
...
fn vpmovusqb_12() {
    run_test(
        ...
        &[98, 98, 126, 72, 18, 28, 197, 71, 155, 142, 4],
        OperandSize::Qword,
    )
}
