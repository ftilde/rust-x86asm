...
fn vbroadcasti32x2_2() {
    run_test(
        ...
        &[98, 242, 125, 142, 89, 191, 209, 143, 181, 86],
        OperandSize::Dword,
    )
}
...
fn vbroadcasti32x2_6() {
    run_test(
        ...
        &[98, 242, 125, 170, 89, 60, 157, 240, 41, 140, 5],
        OperandSize::Dword,
    )
}
...
fn vbroadcasti32x2_8() {
    run_test(
        ...
        &[98, 226, 125, 172, 89, 187, 16, 80, 121, 114],
        OperandSize::Qword,
    )
}
...
fn vbroadcasti32x2_10() {
    run_test(
        ...
        &[98, 242, 125, 201, 89, 180, 178, 96, 25, 233, 16],
        OperandSize::Dword,
    )
}
...
fn vbroadcasti32x2_12() {
    run_test(
        ...
        &[98, 114, 125, 203, 89, 168, 47, 247, 232, 102],
        OperandSize::Qword,
    )
}
