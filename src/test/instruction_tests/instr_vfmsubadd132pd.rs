...
fn vfmsubadd132pd_2() {
    run_test(
        ...
        &[196, 226, 249, 151, 180, 246, 60, 114, 200, 17],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd132pd_4() {
    run_test(
        ...
        &[196, 226, 233, 151, 28, 141, 195, 125, 248, 49],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd132pd_8() {
    run_test(
        ...
        &[196, 226, 253, 151, 151, 124, 234, 15, 108],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd132pd_10() {
    run_test(
        ...
        &[98, 242, 229, 141, 151, 134, 26, 63, 3, 104],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd132pd_11() {
    run_test(
        ...
        &[98, 242, 245, 159, 151, 60, 77, 245, 64, 71, 125],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd132pd_14() {
    run_test(
        ...
        &[98, 242, 133, 159, 151, 155, 164, 53, 88, 82],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd132pd_16() {
    run_test(
        ...
        &[98, 242, 237, 169, 151, 172, 254, 60, 38, 29, 55],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd132pd_19() {
    run_test(
        ...
        &[98, 226, 229, 165, 151, 178, 189, 29, 237, 114],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd132pd_20() {
    run_test(
        ...
        &[98, 114, 173, 191, 151, 60, 221, 127, 111, 228, 29],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd132pd_22() {
    run_test(
        ...
        &[98, 242, 253, 204, 151, 164, 64, 255, 253, 202, 54],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd132pd_23() {
    run_test(
        ...
        &[98, 242, 205, 220, 151, 168, 7, 23, 234, 19],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd132pd_26() {
    run_test(
        ...
        &[98, 242, 213, 211, 151, 20, 253, 202, 75, 56, 111],
        OperandSize::Qword,
    )
}
