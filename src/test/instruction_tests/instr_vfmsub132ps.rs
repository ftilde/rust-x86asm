...
fn vfmsub132ps_4() {
    run_test(
        ...
        &[196, 226, 89, 154, 188, 67, 88, 46, 13, 100],
        OperandSize::Qword,
    )
}
...
fn vfmsub132ps_8() {
    run_test(
        ...
        &[196, 226, 93, 154, 188, 65, 244, 183, 87, 54],
        OperandSize::Qword,
    )
}
...
fn vfmsub132ps_10() {
    run_test(
        ...
        &[98, 242, 85, 143, 154, 172, 192, 234, 77, 229, 92],
        OperandSize::Dword,
    )
}
...
fn vfmsub132ps_11() {
    run_test(
        ...
        &[98, 242, 69, 156, 154, 138, 51, 85, 129, 50],
        OperandSize::Dword,
    )
}
...
fn vfmsub132ps_13() {
    run_test(
        ...
        &[98, 114, 29, 129, 154, 4, 253, 79, 102, 54, 110],
        OperandSize::Qword,
    )
}
...
fn vfmsub132ps_14() {
    run_test(
        ...
        &[98, 98, 5, 159, 154, 148, 200, 6, 94, 67, 59],
        OperandSize::Qword,
    )
}
...
fn vfmsub132ps_16() {
    run_test(
        ...
        &[98, 242, 93, 173, 154, 156, 193, 64, 78, 112, 67],
        OperandSize::Dword,
    )
}
...
fn vfmsub132ps_25() {
    run_test(
        ...
        &[98, 242, 37, 205, 154, 140, 146, 130, 44, 46, 5],
        OperandSize::Qword,
    )
}
...
fn vfmsub132ps_26() {
    run_test(
        ...
        &[98, 98, 85, 223, 154, 152, 220, 220, 86, 63],
        OperandSize::Qword,
    )
}
