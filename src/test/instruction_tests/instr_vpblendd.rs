...
fn vpblendd_4() {
    run_test(
        ...
        &[196, 227, 105, 2, 12, 189, 154, 114, 108, 83, 59],
        OperandSize::Qword,
    )
}
...
fn vpblendd_6() {
    run_test(
        ...
        &[196, 227, 117, 2, 60, 245, 125, 185, 204, 61, 82],
        OperandSize::Dword,
    )
}
...
fn vpblendd_8() {
    run_test(
        ...
        &[196, 227, 77, 2, 140, 183, 46, 47, 1, 71, 113],
        OperandSize::Qword,
    )
}
