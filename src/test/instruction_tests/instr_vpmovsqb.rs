...
fn vpmovsqb_2() {
    run_test(
        ...
        &[98, 242, 126, 8, 34, 180, 123, 50, 216, 101, 127],
        OperandSize::Dword,
    )
}
...
fn vpmovsqb_4() {
    run_test(
        ...
        &[98, 114, 126, 8, 34, 143, 96, 101, 236, 108],
        OperandSize::Qword,
    )
}
...
fn vpmovsqb_6() {
    run_test(
        ...
        &[98, 242, 126, 40, 34, 150, 55, 83, 187, 46],
        OperandSize::Dword,
    )
}
...
fn vpmovsqb_8() {
    run_test(
        ...
        &[98, 242, 126, 40, 34, 164, 118, 178, 200, 27, 5],
        OperandSize::Qword,
    )
}
...
fn vpmovsqb_12() {
    run_test(
        ...
        &[98, 242, 126, 72, 34, 60, 221, 105, 198, 220, 84],
        OperandSize::Qword,
    )
}
