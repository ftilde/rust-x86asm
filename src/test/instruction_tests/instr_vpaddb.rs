...
fn vpaddb_4() {
    run_test(
        ...
        &[197, 209, 252, 164, 112, 35, 120, 56, 122],
        OperandSize::Qword,
    )
}
...
fn vpaddb_10() {
    run_test(
        ...
        &[98, 241, 69, 137, 252, 148, 215, 13, 21, 146, 66],
        OperandSize::Dword,
    )
}
...
fn vpaddb_12() {
    run_test(
        ...
        &[98, 97, 37, 134, 252, 44, 125, 242, 64, 89, 94],
        OperandSize::Qword,
    )
}
...
fn vpaddb_14() {
    run_test(
        ...
        &[98, 241, 93, 170, 252, 188, 80, 11, 170, 122, 112],
        OperandSize::Dword,
    )
}
...
fn vpaddb_16() {
    run_test(
        ...
        &[98, 241, 5, 175, 252, 131, 126, 123, 54, 57],
        OperandSize::Qword,
    )
}
