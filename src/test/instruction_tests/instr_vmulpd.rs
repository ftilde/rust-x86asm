...
fn vmulpd_10() {
    run_test(
        ...
        &[98, 241, 221, 141, 89, 36, 125, 106, 54, 107, 42],
        OperandSize::Dword,
    )
}
...
fn vmulpd_13() {
    run_test(
        ...
        &[98, 97, 133, 134, 89, 132, 203, 190, 193, 60, 76],
        OperandSize::Qword,
    )
}
...
fn vmulpd_19() {
    run_test(
        ...
        &[98, 225, 253, 166, 89, 155, 130, 198, 246, 74],
        OperandSize::Qword,
    )
}
...
fn vmulpd_20() {
    run_test(
        ...
        &[98, 113, 221, 181, 89, 4, 149, 249, 146, 226, 54],
        OperandSize::Qword,
    )
}
...
fn vmulpd_22() {
    run_test(
        ...
        &[98, 241, 245, 205, 89, 140, 223, 20, 90, 172, 31],
        OperandSize::Dword,
    )
}
...
fn vmulpd_23() {
    run_test(
        ...
        &[98, 241, 221, 222, 89, 163, 208, 127, 213, 84],
        OperandSize::Dword,
    )
}
...
fn vmulpd_25() {
    run_test(
        ...
        &[98, 241, 173, 197, 89, 140, 75, 26, 236, 195, 62],
        OperandSize::Qword,
    )
}
...
fn vmulpd_26() {
    run_test(
        ...
        &[98, 97, 141, 210, 89, 156, 115, 77, 108, 42, 69],
        OperandSize::Qword,
    )
}
