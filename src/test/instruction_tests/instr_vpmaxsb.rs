...
fn vpmaxsb_8() {
    run_test(
        ...
        &[196, 226, 125, 60, 36, 189, 3, 249, 76, 95],
        OperandSize::Qword,
    )
}
...
fn vpmaxsb_10() {
    run_test(
        ...
        &[98, 242, 109, 137, 60, 178, 95, 111, 97, 16],
        OperandSize::Dword,
    )
}
...
fn vpmaxsb_12() {
    run_test(
        ...
        &[98, 114, 37, 135, 60, 172, 217, 53, 231, 28, 19],
        OperandSize::Qword,
    )
}
...
fn vpmaxsb_16() {
    run_test(
        ...
        &[98, 114, 69, 171, 60, 188, 80, 27, 188, 91, 43],
        OperandSize::Qword,
    )
}
