...
fn vcvtpd2dq_4() {
    run_test(
        ...
        &[197, 251, 230, 148, 223, 0, 182, 175, 121],
        OperandSize::Qword,
    )
}
...
fn vcvtpd2dq_8() {
    run_test(
        ...
        &[197, 255, 230, 140, 64, 220, 97, 40, 37],
        OperandSize::Qword,
    )
}
...
fn vcvtpd2dq_14() {
    run_test(
        ...
        &[98, 241, 255, 170, 230, 156, 198, 193, 38, 100, 114],
        OperandSize::Dword,
    )
}
...
fn vcvtpd2dq_16() {
    run_test(
        ...
        &[98, 113, 255, 174, 230, 175, 2, 151, 79, 121],
        OperandSize::Qword,
    )
}
...
fn vcvtpd2dq_20() {
    run_test(
        ...
        &[98, 113, 255, 204, 230, 36, 189, 102, 136, 133, 11],
        OperandSize::Qword,
    )
}
