...
fn vaddss_2() {
    run_test(
        ...
        &[197, 194, 88, 164, 178, 20, 132, 30, 86],
        OperandSize::Dword,
    )
}
...
fn vaddss_4() {
    run_test(
        ...
        &[197, 194, 88, 180, 112, 59, 82, 117, 81],
        OperandSize::Qword,
    )
}
...
fn vaddss_8() {
    run_test(
        ...
        &[98, 97, 6, 141, 88, 60, 149, 179, 39, 137, 74],
        OperandSize::Qword,
    )
}
