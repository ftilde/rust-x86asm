...
fn vfnmsub132pd_4() {
    run_test(
        ...
        &[196, 226, 249, 158, 164, 222, 204, 16, 129, 53],
        OperandSize::Qword,
    )
}
...
fn vfnmsub132pd_6() {
    run_test(
        ...
        &[196, 226, 253, 158, 60, 69, 52, 154, 77, 70],
        OperandSize::Dword,
    )
}
...
fn vfnmsub132pd_8() {
    run_test(
        ...
        &[196, 226, 197, 158, 44, 117, 154, 103, 44, 59],
        OperandSize::Qword,
    )
}
...
fn vfnmsub132pd_11() {
    run_test(
        ...
        &[98, 242, 253, 158, 158, 28, 69, 144, 198, 196, 61],
        OperandSize::Dword,
    )
}
...
fn vfnmsub132pd_14() {
    run_test(
        ...
        &[98, 242, 165, 149, 158, 148, 146, 238, 125, 255, 5],
        OperandSize::Qword,
    )
}
...
fn vfnmsub132pd_16() {
    run_test(
        ...
        &[98, 242, 205, 170, 158, 188, 203, 89, 4, 14, 94],
        OperandSize::Dword,
    )
}
...
fn vfnmsub132pd_19() {
    run_test(
        ...
        &[98, 98, 141, 167, 158, 164, 135, 3, 27, 230, 74],
        OperandSize::Qword,
    )
}
...
fn vfnmsub132pd_20() {
    run_test(
        ...
        &[98, 114, 181, 183, 158, 130, 110, 27, 251, 101],
        OperandSize::Qword,
    )
}
...
fn vfnmsub132pd_22() {
    run_test(
        ...
        &[98, 242, 205, 207, 158, 52, 245, 164, 240, 180, 52],
        OperandSize::Dword,
    )
}
...
fn vfnmsub132pd_25() {
    run_test(
        ...
        &[98, 226, 221, 207, 158, 148, 193, 92, 129, 61, 5],
        OperandSize::Qword,
    )
}
