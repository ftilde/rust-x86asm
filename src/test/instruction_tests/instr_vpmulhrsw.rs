...
fn vpmulhrsw_2() {
    run_test(
        ...
        &[196, 226, 81, 11, 52, 125, 197, 240, 172, 39],
        OperandSize::Dword,
    )
}
...
fn vpmulhrsw_10() {
    run_test(
        ...
        &[98, 242, 77, 141, 11, 44, 157, 58, 164, 211, 3],
        OperandSize::Dword,
    )
}
...
fn vpmulhrsw_14() {
    run_test(
        ...
        &[98, 242, 101, 173, 11, 12, 133, 106, 82, 78, 4],
        OperandSize::Dword,
    )
}
...
fn vpmulhrsw_20() {
    run_test(
        ...
        &[98, 242, 101, 203, 11, 180, 186, 8, 63, 205, 29],
        OperandSize::Qword,
    )
}
