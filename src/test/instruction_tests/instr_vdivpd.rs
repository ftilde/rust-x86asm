...
fn vdivpd_4() {
    run_test(
        ...
        &[197, 233, 94, 140, 70, 1, 194, 113, 87],
        OperandSize::Qword,
    )
}
...
fn vdivpd_6() {
    run_test(
        ...
        &[197, 221, 94, 164, 143, 86, 167, 111, 31],
        OperandSize::Dword,
    )
}
...
fn vdivpd_13() {
    run_test(
        ...
        &[98, 225, 181, 135, 94, 44, 149, 7, 75, 98, 85],
        OperandSize::Qword,
    )
}
...
fn vdivpd_16() {
    run_test(
        ...
        &[98, 241, 245, 174, 94, 36, 141, 250, 134, 165, 0],
        OperandSize::Dword,
    )
}
...
fn vdivpd_19() {
    run_test(
        ...
        &[98, 113, 173, 174, 94, 132, 144, 46, 15, 49, 59],
        OperandSize::Qword,
    )
}
...
fn vdivpd_20() {
    run_test(
        ...
        &[98, 113, 205, 186, 94, 146, 48, 99, 157, 57],
        OperandSize::Qword,
    )
}
...
fn vdivpd_22() {
    run_test(
        ...
        &[98, 241, 221, 203, 94, 185, 178, 236, 235, 4],
        OperandSize::Dword,
    )
}
...
fn vdivpd_23() {
    run_test(
        ...
        &[98, 241, 221, 218, 94, 52, 221, 252, 7, 27, 25],
        OperandSize::Dword,
    )
}
