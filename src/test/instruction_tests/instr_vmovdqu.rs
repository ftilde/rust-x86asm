...
fn vmovdqu_8() {
    run_test(
        ...
        &[197, 254, 111, 52, 221, 241, 182, 169, 66],
        OperandSize::Qword,
    )
}
...
fn vmovdqu_10() {
    run_test(
        ...
        &[197, 250, 127, 4, 157, 250, 165, 181, 25],
        OperandSize::Dword,
    )
}
...
fn vmovdqu_14() {
    run_test(
        ...
        &[197, 254, 127, 172, 91, 63, 136, 236, 54],
        OperandSize::Dword,
    )
}
...
fn vmovdqu_16() {
    run_test(
        &Instruction {
            mnemonic: Mnemonic::VMOVDQU,
            operand1: Some(Indirect(RSI, Some(OperandSize::Ymmword), None)),
            operand2: Some(Direct(YMM4)),
            operand3: None,
            operand4: None,
            lock: false,
