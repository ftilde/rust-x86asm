...
fn vpmaddubsw_2() {
    run_test(
        ...
        &[196, 226, 121, 4, 28, 253, 88, 91, 237, 118],
        OperandSize::Dword,
    )
}
...
fn vpmaddubsw_4() {
    run_test(
        ...
        &[196, 226, 97, 4, 151, 140, 252, 86, 79],
        OperandSize::Qword,
    )
}
...
fn vpmaddubsw_6() {
    run_test(
        ...
        &[196, 226, 69, 4, 172, 254, 95, 9, 45, 62],
        OperandSize::Dword,
    )
}
...
fn vpmaddubsw_12() {
    run_test(
        ...
        &[98, 114, 101, 140, 4, 132, 183, 29, 66, 139, 31],
        OperandSize::Qword,
    )
}
...
fn vpmaddubsw_14() {
    run_test(
        ...
        &[98, 242, 93, 170, 4, 4, 141, 186, 80, 237, 94],
        OperandSize::Dword,
    )
}
...
fn vpmaddubsw_16() {
    run_test(
        ...
        &[98, 226, 13, 171, 4, 4, 213, 114, 189, 178, 86],
        OperandSize::Qword,
    )
}
...
fn vpmaddubsw_18() {
    run_test(
        ...
        &[98, 242, 77, 203, 4, 60, 133, 161, 232, 164, 60],
        OperandSize::Dword,
    )
}
...
fn vpmaddubsw_20() {
    run_test(
        ...
        &[98, 242, 13, 202, 4, 12, 181, 196, 205, 245, 17],
        OperandSize::Qword,
    )
}
