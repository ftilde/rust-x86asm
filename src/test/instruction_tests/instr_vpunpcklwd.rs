...
fn vpunpcklwd_4() {
    run_test(
        ...
        &[197, 209, 97, 171, 240, 196, 243, 108],
        OperandSize::Qword,
    )
}
...
fn vpunpcklwd_6() {
    run_test(
        ...
        &[197, 229, 97, 44, 253, 237, 116, 152, 18],
        OperandSize::Dword,
    )
}
...
fn vpunpcklwd_10() {
    run_test(
        ...
        &[98, 241, 109, 141, 97, 129, 167, 207, 0, 35],
        OperandSize::Dword,
    )
}
...
fn vpunpcklwd_12() {
    run_test(
        ...
        &[98, 97, 117, 142, 97, 156, 82, 197, 127, 111, 15],
        OperandSize::Qword,
    )
}
