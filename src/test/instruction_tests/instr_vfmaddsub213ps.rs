...
fn vfmaddsub213ps_2() {
    run_test(
        ...
        &[196, 226, 105, 166, 158, 39, 184, 163, 114],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213ps_4() {
    run_test(
        ...
        &[196, 226, 73, 166, 20, 85, 115, 1, 119, 71],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub213ps_6() {
    run_test(
        ...
        &[196, 226, 93, 166, 36, 205, 74, 149, 24, 98],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213ps_8() {
    run_test(
        ...
        &[196, 226, 69, 166, 20, 253, 125, 211, 55, 48],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub213ps_10() {
    run_test(
        ...
        &[98, 242, 109, 141, 166, 4, 93, 141, 178, 252, 57],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213ps_11() {
    run_test(
        ...
        &[98, 242, 117, 156, 166, 20, 77, 34, 215, 255, 104],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213ps_13() {
    run_test(
        ...
        &[98, 226, 13, 139, 166, 188, 254, 115, 59, 16, 27],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub213ps_17() {
    run_test(
        ...
        &[98, 242, 77, 185, 166, 60, 149, 118, 226, 61, 127],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213ps_20() {
    run_test(
        ...
        &[98, 98, 45, 182, 166, 36, 77, 241, 234, 120, 11],
        OperandSize::Qword,
    )
}
...
fn vfmaddsub213ps_22() {
    run_test(
        ...
        &[98, 242, 101, 207, 166, 186, 175, 42, 163, 9],
        OperandSize::Dword,
    )
}
...
fn vfmaddsub213ps_23() {
    run_test(
        ...
        &[98, 242, 101, 221, 166, 156, 249, 132, 101, 168, 17],
        OperandSize::Dword,
    )
}
