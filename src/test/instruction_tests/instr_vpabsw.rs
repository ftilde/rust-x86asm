...
fn vpabsw_2() {
    run_test(
        ...
        &[196, 226, 121, 29, 60, 69, 167, 208, 107, 106],
        OperandSize::Dword,
    )
}
...
fn vpabsw_4() {
    run_test(
        ...
        &[196, 226, 121, 29, 44, 141, 31, 53, 188, 5],
        OperandSize::Qword,
    )
}
...
fn vpabsw_6() {
    run_test(
        ...
        &[196, 226, 125, 29, 60, 221, 30, 190, 41, 44],
        OperandSize::Dword,
    )
}
...
fn vpabsw_10() {
    run_test(
        ...
        &[98, 242, 125, 138, 29, 146, 66, 241, 127, 66],
        OperandSize::Dword,
    )
}
