...
fn vpmovqb_4() {
    run_test(
        ...
        &[98, 242, 126, 8, 50, 156, 209, 142, 9, 152, 4],
        OperandSize::Qword,
    )
}
...
fn vpmovqb_6() {
    run_test(
        ...
        &[98, 242, 126, 40, 50, 180, 119, 142, 248, 99, 90],
        OperandSize::Dword,
    )
}
...
fn vpmovqb_10() {
    run_test(
        ...
        &[98, 242, 126, 72, 50, 4, 77, 249, 53, 17, 22],
        OperandSize::Dword,
    )
}
