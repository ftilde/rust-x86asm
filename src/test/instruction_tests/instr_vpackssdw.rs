...
fn vpackssdw_6() {
    run_test(
        ...
        &[197, 245, 107, 20, 85, 118, 70, 57, 105],
        OperandSize::Dword,
    )
}
...
fn vpackssdw_8() {
    run_test(
        ...
        &[197, 253, 107, 140, 202, 174, 152, 185, 54],
        OperandSize::Qword,
    )
}
...
fn vpackssdw_10() {
    run_test(
        ...
        &[98, 241, 117, 143, 107, 52, 157, 127, 70, 86, 41],
        OperandSize::Dword,
    )
}
...
fn vpackssdw_13() {
    run_test(
        ...
        &[98, 241, 93, 131, 107, 28, 205, 59, 244, 219, 51],
        OperandSize::Qword,
    )
}
...
fn vpackssdw_14() {
    run_test(
        ...
        &[98, 113, 21, 148, 107, 187, 48, 145, 202, 16],
        OperandSize::Qword,
    )
}
