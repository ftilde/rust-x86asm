...
fn vfnmadd213ss_2() {
    run_test(
        ...
        &[196, 226, 73, 173, 60, 141, 120, 111, 62, 89],
        OperandSize::Dword,
    )
}
...
fn vfnmadd213ss_4() {
    run_test(
        ...
        &[196, 226, 105, 173, 4, 181, 236, 134, 112, 75],
        OperandSize::Qword,
    )
}
...
fn vfnmadd213ss_6() {
    run_test(
        ...
        &[98, 242, 69, 139, 173, 44, 253, 213, 219, 39, 97],
        OperandSize::Dword,
    )
}
