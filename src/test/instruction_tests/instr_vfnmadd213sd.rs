...
fn vfnmadd213sd_2() {
    run_test(
        ...
        &[196, 226, 241, 173, 4, 125, 24, 125, 3, 96],
        OperandSize::Dword,
    )
}
...
fn vfnmadd213sd_6() {
    run_test(
        ...
        &[98, 242, 229, 139, 173, 28, 213, 194, 26, 161, 13],
        OperandSize::Dword,
    )
}
...
fn vfnmadd213sd_8() {
    run_test(
        ...
        &[98, 242, 133, 142, 173, 143, 120, 115, 60, 1],
        OperandSize::Qword,
    )
}
