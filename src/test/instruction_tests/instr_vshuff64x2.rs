...
fn vshuff64x2_2() {
    run_test(
        ...
        &[98, 243, 253, 201, 35, 129, 193, 162, 151, 75, 97],
        OperandSize::Dword,
    )
}
...
fn vshuff64x2_5() {
    run_test(
        ...
        &[98, 115, 133, 203, 35, 20, 141, 55, 65, 118, 31, 30],
        OperandSize::Qword,
    )
}
