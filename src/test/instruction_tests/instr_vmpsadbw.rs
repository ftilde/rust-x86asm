...
fn vmpsadbw_2() {
    run_test(
        ...
        &[196, 227, 113, 66, 188, 155, 125, 128, 188, 80, 27],
        OperandSize::Dword,
    )
}
...
fn vmpsadbw_4() {
    run_test(
        ...
        &[196, 227, 113, 66, 153, 93, 47, 157, 42, 38],
        OperandSize::Qword,
    )
}
...
fn vmpsadbw_8() {
    run_test(
        ...
        &[196, 227, 69, 66, 140, 182, 194, 122, 121, 119, 101],
        OperandSize::Qword,
    )
}
