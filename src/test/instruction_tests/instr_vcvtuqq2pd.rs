...
fn vcvtuqq2pd_2() {
    run_test(
        ...
        &[98, 241, 254, 139, 122, 163, 111, 33, 109, 61],
        OperandSize::Dword,
    )
}
...
fn vcvtuqq2pd_4() {
    run_test(
        ...
        &[98, 241, 254, 137, 122, 152, 221, 64, 106, 80],
        OperandSize::Qword,
    )
}
...
fn vcvtuqq2pd_6() {
    run_test(
        ...
        &[98, 241, 254, 172, 122, 164, 193, 117, 147, 174, 20],
        OperandSize::Dword,
    )
}
...
fn vcvtuqq2pd_8() {
    run_test(
        ...
        &[98, 113, 254, 170, 122, 152, 109, 44, 160, 92],
        OperandSize::Qword,
    )
}
...
fn vcvtuqq2pd_10() {
    run_test(
        ...
        &[98, 241, 254, 201, 122, 132, 243, 255, 165, 20, 66],
        OperandSize::Dword,
    )
}
...
fn vcvtuqq2pd_12() {
    run_test(
        ...
        &[98, 225, 254, 203, 122, 151, 152, 90, 144, 5],
        OperandSize::Qword,
    )
}
