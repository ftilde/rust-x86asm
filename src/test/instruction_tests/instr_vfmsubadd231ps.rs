...
fn vfmsubadd231ps_2() {
    run_test(
        ...
        &[196, 226, 121, 183, 52, 141, 182, 149, 224, 88],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd231ps_4() {
    run_test(
        ...
        &[196, 226, 105, 183, 52, 213, 155, 233, 8, 65],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd231ps_6() {
    run_test(
        ...
        &[196, 226, 117, 183, 60, 149, 56, 112, 191, 2],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd231ps_8() {
    run_test(
        ...
        &[196, 226, 101, 183, 132, 88, 161, 61, 167, 75],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd231ps_10() {
    run_test(
        ...
        &[98, 242, 69, 137, 183, 28, 85, 199, 101, 243, 68],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd231ps_11() {
    run_test(
        ...
        &[98, 242, 77, 154, 183, 188, 113, 40, 105, 199, 111],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd231ps_13() {
    run_test(
        ...
        &[98, 114, 77, 129, 183, 36, 69, 154, 115, 245, 31],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd231ps_14() {
    run_test(
        ...
        &[98, 242, 21, 150, 183, 177, 52, 42, 206, 119],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd231ps_17() {
    run_test(
        ...
        &[98, 242, 101, 185, 183, 177, 197, 243, 76, 8],
        OperandSize::Dword,
    )
}
...
fn vfmsubadd231ps_19() {
    run_test(
        ...
        &[98, 226, 117, 173, 183, 168, 60, 209, 181, 46],
        OperandSize::Qword,
    )
}
...
fn vfmsubadd231ps_23() {
    run_test(
        ...
        &[98, 242, 117, 218, 183, 164, 191, 170, 251, 88, 100],
        OperandSize::Dword,
    )
}
