...
fn vcompressps_2() {
    run_test(
        ...
        &[98, 242, 125, 8, 138, 152, 176, 229, 50, 78],
        OperandSize::Dword,
    )
}
...
fn vcompressps_4() {
    run_test(
        ...
        &[98, 98, 125, 8, 138, 147, 94, 252, 101, 106],
        OperandSize::Qword,
    )
}
...
fn vcompressps_8() {
    run_test(
        ...
        &[98, 242, 125, 40, 138, 4, 93, 63, 228, 225, 16],
        OperandSize::Qword,
    )
}
...
fn vcompressps_10() {
    run_test(
        ...
        &[98, 242, 125, 72, 138, 140, 154, 186, 251, 150, 90],
        OperandSize::Dword,
    )
}
...
fn vcompressps_12() {
    run_test(
        &Instruction {
            mnemonic: Mnemonic::VCOMPRESSPS,
            operand1: Some(Indirect(RAX, Some(OperandSize::Zmmword), None)),
