...
fn vfmsub231ss_6() {
    run_test(
        ...
        &[98, 242, 77, 141, 187, 36, 181, 248, 189, 32, 40],
        OperandSize::Dword,
    )
}
...
fn vfmsub231ss_8() {
    run_test(
        ...
        &[98, 114, 85, 133, 187, 164, 138, 120, 18, 163, 75],
        OperandSize::Qword,
    )
}
