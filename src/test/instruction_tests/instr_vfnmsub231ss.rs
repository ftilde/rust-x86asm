...
fn vfnmsub231ss_6() {
    run_test(
        ...
        &[98, 242, 77, 137, 191, 151, 185, 61, 127, 79],
        OperandSize::Dword,
    )
}
...
fn vfnmsub231ss_8() {
    run_test(
        ...
        &[98, 226, 37, 132, 191, 169, 237, 58, 194, 120],
        OperandSize::Qword,
    )
}
